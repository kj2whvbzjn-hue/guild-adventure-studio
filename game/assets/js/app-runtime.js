...
function equipInventoryItemToCharacter(character,index,targetSlot=''){
 ...
 data.inventory.splice(index,1);if(returned.length)data.inventory.push(...returned);
