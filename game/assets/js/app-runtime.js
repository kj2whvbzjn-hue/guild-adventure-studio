...
function makeBattleUnits(){
 ...
 const enemies=expanded.map((e,i)=>makeCombatant({id:`E${i}`,monsterId:e.monster_id,name:e.name,side:'敵',aiPolicy:e.aiPolicy,ownedSkillIds:clone(e.skillIds||[]),defaultSkillId:e.defaultSkillId,agi:e.agi,attack:e.attack,maxHp:e.maxHp,gauge:0,actions:0,order:100+i,lastActionTick:null}));
