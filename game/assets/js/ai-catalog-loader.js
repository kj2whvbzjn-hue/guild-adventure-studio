(function(root,factory){
  ...
  function normalize(aiRows,skillRows,tags,tagCategories){
  ...
  async function load(options){
    ...
    const catalog=normalize(ai,skills,opts.tags||[],opts.tag_categories||[]);
    return Object.freeze({...catalog,warnings:Object.freeze(warnings)});
  }
  return Object.freeze({rowsFromEnvelope,normalize,load});
});
