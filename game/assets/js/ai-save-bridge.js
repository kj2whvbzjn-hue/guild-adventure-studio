(function(root,factory){
  ...
  const CHARACTER_KEYS=new Set(['id','name','level','job','stats','skills','equippedSkillId','passiveIds','skillLoadoutIds','formalAiBinding','equipment','jobHistory','growthHistory','createdAt']);
  const CHARACTER_REQUIRED=Object.freeze(['id','name','level','job','stats','skills','equippedSkillId','formalAiBinding','equipment','jobHistory','growthHistory','createdAt']);
