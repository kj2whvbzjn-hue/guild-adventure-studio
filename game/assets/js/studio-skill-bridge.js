/* Studio skill data bridge — GKS-B483 / P01-01 HEAL */
...
function buildStudioBridgeValidationReport(){
 const required=['SKL-TEST-ATTACK','SKL-TEST-POISON','SKL-TEST-BUFF-10','SKL-TEST-DEBUFF-10','SKL-TEST-FOLLOW-POISON','SKL-TEST-HEAL-100','SKL-TEST-HEAL-ALL-60'];
