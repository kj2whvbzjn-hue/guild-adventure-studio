...
const CURRENT_BATTLE_DIRECT_MODIFIER_TARGETS=Object.freeze(['BLOCK_RATE','BLOCK_PERFORMANCE','CRITICAL_DAMAGE','CRITICAL_BONUS_DAMAGE_REDUCTION','MP_COST_REDUCTION','COOLDOWN_REDUCTION','CAST_TIME_REDUCTION','MAGIC_ACCURACY','PHYSICAL_DAMAGE','MAGIC_DAMAGE','ACCURACY','EVASION','ACTION_GAUGE_GAIN']);
...
function currentBattleMagicResistance(unit){return Math.max(0,currentBattleFinite(unit?.magicResistance??unit?.magic_resistance,0))}
