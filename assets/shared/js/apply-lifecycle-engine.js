/* GKS APPLY Lifecycle Engine facade — R03-F1
...
(function(root,factory){
  ...
  'use strict';
  const VERSION='R03-F1';
  const OPERATIONS=Object.freeze(['resolve','apply','consume','effective']);
  ...
  function create(handlers={}){
    ...
    return Object.freeze({version:VERSION,kinds:Object.freeze(Object.keys(table)),resolve:(kind,payload)=>invoke('resolve',kind,payload),apply:(kind,payload)=>invoke('apply',kind,payload),consume:(kind,payload)=>invoke('consume',kind,payload),effective:(kind,payload)=>invoke('effective',kind,payload)});
  }
