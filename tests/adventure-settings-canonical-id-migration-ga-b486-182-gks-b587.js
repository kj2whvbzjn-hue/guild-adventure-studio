...
console.log('PASS GA-B486.182 / GKS-B589 Adventure Settings canonical ID migration preserves data, prefers ADV-0001, and keeps ADV-DEFAULT runtime fallback');
