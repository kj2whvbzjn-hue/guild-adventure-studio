...
assert.strictEqual(build.game_build,'GA-B486.183');
...
console.log('PASS GA-B486.183 / GKS-B592 Adventure Settings canonical ID migration preserves data, prefers ADV-0001, and keeps ADV-DEFAULT runtime fallback');
