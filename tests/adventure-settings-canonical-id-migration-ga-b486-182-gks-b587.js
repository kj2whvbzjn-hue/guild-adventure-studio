...
console.log('PASS GA-B486.187 / GKS-B593 Adventure Settings canonical ID migration preserves data, prefers ADV-0001, and keeps ADV-DEFAULT runtime fallback');
