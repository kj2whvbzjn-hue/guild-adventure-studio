...
assert.strictEqual(build.game_build,'GA-B486.95');
...
assert.strictEqual(generated.legacySkill.genericRuntime.triggerContract.type,'ON_HIT_RECEIVED');
assert.strictEqual(generated.legacySkill.genericRuntime.triggerContract.engineEvent,'hit_received');
assert.strictEqual(generated.legacySkill.genericRuntime.triggerContract.dispatchMode,'LEGACY_COUNTER_ADAPTER');
...
console.log('DEVICE_R04_GENERIC_COUNTER_GAME_RUNTIME_GA_B486_95_PASS');
