...
const ctx={console,window:{GA_PROJECT_CONFIG:{skillExportUrl:'x'}},TAG_SKILLS:[]};ctx.globalThis=ctx;vm.createContext(ctx);
...
const compiled=ctx.GKSValidationTagCompiler.compile(row);
