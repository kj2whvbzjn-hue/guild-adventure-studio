...
const html=fs.readFileSync('studio/index.html','utf8');assert.ok(html.includes('generic-skill-budget-engine.js?v=1'));assert.ok(html.includes('generic-skill-authoring-registry.js?v=4'));assert.ok(html.includes('skill-generator.js?v=27'));
