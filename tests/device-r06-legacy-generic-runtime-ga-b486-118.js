...
if(String(exp.data_version||'').startsWith('GA-B486.117')&&String(exp.generated_by||'').includes('GKS-B527'))throw new Error('fixture unexpectedly current; update test expectation and run Studio acceptance');
