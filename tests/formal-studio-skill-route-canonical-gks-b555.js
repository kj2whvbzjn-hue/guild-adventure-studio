...
assert(!studio.includes('g06-roundtrip'));
assert(!studio.includes('G06_Skills.json'));
assert(!studio.includes('data-retired-skill-compat'));
assert(!studio.includes('旧Runtime互換'));
assert(!studio.includes('skgLogics'));
assert(!studio.includes('safeRegisterNewOnly'));
assert(!studio.includes('function buildTags'));
assert(!studio.includes('function generateRecord'));
assert(!studio.includes('runtime-requirements.json'));
assert(!studio.includes('skgGeneric'));
assert(studio.includes('skgFormalEffects'));
assert(studio.includes('buildFormalDraft'));
assert(studio.includes('generateFormalPreview'));
assert(studio.includes('runtimeContracts'));
