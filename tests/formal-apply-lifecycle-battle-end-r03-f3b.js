...
for(const path of ['game/assets/js/tag-skill-runtime.js']){
 ...
 ok(events.some(x=>x.type==='runtime_apply_lifecycle_cleanup'),`${path}: cleanup event missing`);
}
for(const path of ['game/assets/js/battle-control.js']){
...
console.log('FORMAL_APPLY_LIFECYCLE_BATTLE_END_R03_F3B_PASS');
