...
ctx.module={exports:{}};vm.runInContext(fs.readFileSync('assets/shared/js/skill-ai-batch-engine.js','utf8'),ctx);
...
(async()=>{
 const envelope={schema:'GKS_SKILL_AI_BATCH_REQUEST',version:'1.0.0',requests:[
 ...
 const html=fs.readFileSync('studio/index.html','utf8');assert.ok(html.includes('generic-skill-ai-batch-engine.js?v=2'));assert.ok(html.includes('skill-generator.js?v=32'));
