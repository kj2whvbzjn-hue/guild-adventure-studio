...
(async()=>{
 ...
 const html=fs.readFileSync('studio/index.html','utf8');assert.ok(html.includes('generic-skill-ai-batch-engine.js?v=1'));assert.ok(html.includes('skill-generator.js?v=13'));
