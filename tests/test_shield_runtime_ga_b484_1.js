...
const shield=(value=100,duration=500,id='S')=>({id,name:id,environment:'validation',tags:['SHIELD','味方','単体',`SHIELD=${value}`,`DURATION=${duration}`]});
{
...
{
 const {a,t,e}=reset();context.executeSkillRuntime(a,t,shield());const d=context.applyTaggedDamage(e,t,150,{id:'D',name:'D',parameters:{damage:150}});assert(d.shieldAbsorbed===100&&d.damage===50,'overflow');assert(t.hp===250&&context.shieldTotal(t)===0,'overflow state');
}
{
