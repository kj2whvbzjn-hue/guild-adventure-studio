...
(async()=>{
 ...
 const env=await dx.buildEnvelope({rootData:staged,dataset:'skills',ids:[skill.id],dependencyMode:'direct',studioVersion:'GKS-B549'});
 ...
 console.log('PASS GKS-B549 genericRuntime Master contract + G07 Dry Run Apply Plan gate');
