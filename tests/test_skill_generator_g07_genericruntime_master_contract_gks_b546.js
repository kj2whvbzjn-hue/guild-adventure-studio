...
(async()=>{
 ...
 const env=await dx.buildEnvelope({rootData:staged,dataset:'skills',ids:[skill.id],dependencyMode:'direct',studioVersion:'GKS-B546'});
 ...
 assert.ok(html.includes('skill-generator.js?v=24'));
 assert.ok(html.includes('data-exchange-core.js?v=14'));
 console.log('PASS GKS-B546 genericRuntime Master contract + G07 Dry Run Apply Plan gate');
