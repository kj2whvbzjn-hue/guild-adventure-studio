...
(async()=>{
 ...
 const env=await dx.buildEnvelope({rootData:staged,dataset:'skills',ids:[skill.id],dependencyMode:'direct',studioVersion:'GKS-B548'});
 ...
 console.log('PASS GKS-B548 genericRuntime Master contract + G07 Dry Run Apply Plan gate');
