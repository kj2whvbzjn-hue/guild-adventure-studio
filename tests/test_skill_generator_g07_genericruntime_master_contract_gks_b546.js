...
(async()=>{
 ...
 const env=await dx.buildEnvelope({rootData:staged,dataset:'skills',ids:[skill.id],dependencyMode:'direct',studioVersion:'GKS-B547'});
 ...
 assert.ok(html.includes('skill-generator.js?v=25'));
 assert.ok(html.includes('data-exchange-core.js?v=14'));
 console.log('PASS GKS-B547 genericRuntime Master contract + G07 Dry Run Apply Plan gate');
