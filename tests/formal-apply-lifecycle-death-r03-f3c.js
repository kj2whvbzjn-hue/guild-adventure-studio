...
for(const path of ['game/assets/js/tag-skill-runtime.js']){
 ...
 const ev=events.find(x=>x.type==='runtime_apply_lifecycle_death_cleanup');ok(ev,`${path}: lifecycle death event missing`);
...
console.log('FORMAL_APPLY_LIFECYCLE_DEATH_R03_F3C_PASS');
