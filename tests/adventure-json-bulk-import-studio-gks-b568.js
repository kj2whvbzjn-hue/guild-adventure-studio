...
assert.ok(html.includes('./adventure-entity-json-import.js?v=581'),'import core script missing');
console.log('PASS GKS-B581 Quest/Event/Story dedicated JSON bulk import entrances and safe import plan');
