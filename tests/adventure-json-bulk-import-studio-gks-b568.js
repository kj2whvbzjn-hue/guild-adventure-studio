...
assert.ok(html.includes('./adventure-entity-json-import.js?v=568'),'import core script missing');
console.log('PASS GKS-B568 Quest/Event/Story dedicated JSON bulk import entrances and safe import plan');
