...
assert.ok(html.includes('./adventure-entity-json-import.js?v=580'),'import core script missing');
console.log('PASS GKS-B580 Quest/Event/Story dedicated JSON bulk import entrances and safe import plan');
