...
assert.ok(html.includes('./adventure-entity-json-import.js?v=579'),'import core script missing');
console.log('PASS GKS-B579 Quest/Event/Story dedicated JSON bulk import entrances and safe import plan');
