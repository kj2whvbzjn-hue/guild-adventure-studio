...
assert.ok(html.includes('./adventure-entity-json-import.js?v=578'),'import core script missing');
console.log('PASS GKS-B578 Quest/Event/Story dedicated JSON bulk import entrances and safe import plan');
