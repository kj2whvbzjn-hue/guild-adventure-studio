...
assert.strictEqual(build.game_build,'GA-B486.210');
...
console.log('PASS GKS-B639 Studio SOURCE_UPDATE gate hard-excludes root Export/, verifies exact baseline, and rejects non-forward/same-Build artifact reuse');
