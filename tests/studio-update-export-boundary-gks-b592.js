...
assert.strictEqual(build.game_build,'GA-B486.201');
assert.strictEqual(build.studio_build,'GKS-B630');
for(const marker of [
...
console.log('PASS GKS-B630 Studio SOURCE_UPDATE gate hard-excludes root Export/, verifies exact baseline, and rejects non-forward/same-Build artifact reuse');
