...
const data=JSON.parse(fs.readFileSync('Export/skill/skills.json','utf8'));if(data.data_version!=='GA-B486.48-p01-12-activation-priority-validation-v2')throw new Error('data_version mismatch');
