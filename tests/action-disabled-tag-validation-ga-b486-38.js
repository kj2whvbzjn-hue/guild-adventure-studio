...
const data=JSON.parse(fs.readFileSync('Export/skill/skills.json','utf8'));if(data.data_version!=='GA-B486.53-p01-13-seeded-battle-tie-roll-formal-v1')throw new Error('data_version mismatch');
