...
const data=JSON.parse(fs.readFileSync('Export/skill/skills.json','utf8'));if(data.data_version!=='GA-B486.52-p01-13-seeded-battle-tie-roll-collision-validation-v3')throw new Error('data_version mismatch');
