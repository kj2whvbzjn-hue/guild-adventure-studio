...
assert(runtime.includes("build:'GA-B486'"),'JSON buildがGA-B486ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B486-'),'JSONファイル名がGA-B486ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4860'),'ルートService Workerキャッシュが更新されていません');
