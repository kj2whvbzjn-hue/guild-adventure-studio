...
assert(runtime.includes("build:'GA-B486.1'"),'JSON buildがGA-B486.1ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B486.1-'),'JSONファイル名がGA-B486.1ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4861'),'ルートService Workerキャッシュが更新されていません');
