...
assert(runtime.includes("build:'GA-B485.1'"),'JSON buildがGA-B485.1ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B485.1-'),'JSONファイル名がGA-B485.1ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4851'),'ルートService Workerキャッシュが更新されていません');
