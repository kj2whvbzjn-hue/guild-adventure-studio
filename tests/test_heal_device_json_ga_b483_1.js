...
assert(runtime.includes("build:'GA-B483.2'"),'JSON buildがGA-B483.2ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B483.2-'),'JSONファイル名がGA-B483.2ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4832'),'ルートService Workerキャッシュが更新されていません');
