...
assert(runtime.includes("build:'GA-B484.2'"),'JSON buildがGA-B484.2ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B484.2-'),'JSONファイル名がGA-B484.2ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4842'),'ルートService Workerキャッシュが更新されていません');
