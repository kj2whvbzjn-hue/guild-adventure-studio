...
assert(runtime.includes("build:'GA-B485'"),'JSON buildがGA-B485ではありません');
assert(runtime.includes('tag-heal-device-validation-GA-B485-'),'JSONファイル名がGA-B485ではありません');
assert(runtime.includes('ensureHealValidationFixtures'),'回復検証fixtureがありません');
assert(rootSw.includes('ga-root-b4850'),'ルートService Workerキャッシュが更新されていません');
