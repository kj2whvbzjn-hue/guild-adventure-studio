...
for(const source of [exp,expRoot])assert(source.includes("'system/drop_tables.json':clean(masters.reward_tables||[])"),'P7-C Export must use the Formal Reward Table Master');
