...
function validProject(){return {
  ...
  characters:[],organizations:[],terms:[],relationships:[],timeline:[],battle_tests:[],battle_snapshots:[],tags:[{id:'TAG-0001',name:'Tag'}],tag_categories:[],ai_programs:[],
  masters:{stats:[{id:'STA-0001',name:'STR'}],jobs:[],skills:[],equipment:[],mods:[],monsters:[],status_effects:[],tablets:[],ai_conditions:[],ai_targets:[],ai_actions:[],maps:[],exploration_outcomes:[],reward_tables:[],adventure_settings:[{id:'ADV-0001',name:'Default'}]}
}}
...
(async()=>{
  ...
  const partialRoot={schema_version:'4.0.0-draft',project:{id:'PRJ-DEMO',updated_at:'R1'},tags:[],masters:{monsters:[{id:'MON-0001',name:'M',tags:[],params:{}}],skills:[],jobs:[],equipment:[],mods:[],stats:[],status_effects:[],tablets:[],ai_conditions:[],ai_targets:[],ai_actions:[],maps:[],exploration_outcomes:[],adventure_settings:[]}};
  ...
  for(const marker of ['JSON全件読込','full-import-gate.js?v=1','buildFullImportGateReport','buildMultiProjectImportGateReport','importAllProjectsPackage','exportFullImportAiFix','buildMasterIdReferenceAudit(candidate)','buildGameDataIdReferenceAudit(candidate)','runValidation(options={})','1件でもERRORがあれば登録0件'])assert(html.includes(marker),marker+' missing');
  ...
  console.log('PASS GKS-B593 full JSON preflight gate + strict partial ID gate');
