...
assert.ok(html.includes('Game GA-B486.186 / Studio GKS-B593'),'Studio header build must not show the stale GKS-B527 label');
...
assert.ok(sw.includes('const CACHE_NAME="gks-studio-b593"'),'Studio cache namespace must advance');
