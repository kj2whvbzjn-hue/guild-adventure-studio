...
function saveBase(){const p=program('AIP-0002','Migrated Player AI'),l=layout('AIL-0002','AIP-0002');return{saveVersion:4,schemaRevision:'1.7.0',gameVersion:'GA-B486.213',createdAt:'2026-09-03T00:00:00Z',updatedAt:'2026-09-03T00:00:00Z',characters:[character('C-1','アルト',{program_id:'AIP-0002',layout_id:'AIL-0002'}),character('C-2','イルト',null)],aiPrograms:[p],aiLayouts:[l],aiPresets:[],partyIds:['C-1','C-2'],selectedQuestId:'',inventory:[],guild:{gold:0,victories:0,defeats:0,lastBattle:null},flags:{},quest_progress:{completed_quest_ids:[],unlocked_quest_ids:[]},quest_resources:{},adventure:{quest_runs:[],active_quest_run_id:'',history_limit:20,stone_selection_by_quest:{}},gameSettings:{},tutorialProgress:{}};}
