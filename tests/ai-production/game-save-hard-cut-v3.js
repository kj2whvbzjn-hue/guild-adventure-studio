...
const current={saveVersion:3,schemaRevision:'1.6.0',gameVersion:'GA-B486.205',createdAt:'2026-08-17T00:00:00Z',updatedAt:'2026-08-17T00:00:00Z',characters:[makeCharacter()],aiPrograms:[],aiLayouts:[],aiPresets:[],partyIds:['C-1'],selectedQuestId:'',inventory:[],guild:{gold:0,victories:0,defeats:0,lastBattle:null},flags:{},quest_progress:{completed_quest_ids:[],unlocked_quest_ids:[]},quest_resources:{},adventure:{quest_runs:[],active_quest_run_id:'',history_limit:20,stone_selection_by_quest:{}}};
