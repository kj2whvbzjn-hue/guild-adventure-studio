...
const runtime={schema_version:'2.0.0',data_version:'1.0.0',program_id:'AIP-9153',program_version:1,compiler_version:'2.0.0',entry_instruction:'I-1',instructions:[{instruction_id:'I-1',op:'ACTION',origin_part_id:'AIN-ACTION',source_node_id:'AIN-ACTION',master_node_id:'AIA-ATTACK',evaluator:'action.attack',params:{},target_selector:{selector_id:'ATS-RANDOM',params:{}}}],source_map:{'I-1':{origin_part_id:'AIN-ACTION',source_node_id:'AIN-ACTION'}},limits:{max_steps:1,max_subroutine_depth:0},content_hash:'0'.repeat(64)};
