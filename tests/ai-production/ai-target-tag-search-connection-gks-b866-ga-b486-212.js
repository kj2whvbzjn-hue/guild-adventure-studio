...
(async()=>{
  ...
  const context={GKExportCore:ExportCore,data:project,DISTRIBUTION_BUILD:'GKS-B866'};
  ...
  assert.strictEqual(build.studio_build,'GKS-B866');assert.strictEqual(build.game_build,'GA-B486.212');
