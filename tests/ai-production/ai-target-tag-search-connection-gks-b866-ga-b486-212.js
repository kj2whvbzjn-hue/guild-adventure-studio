...
(async()=>{
  ...
  const context={GKExportCore:ExportCore,data:project,DISTRIBUTION_BUILD:'GKS-B867'};
  ...
  assert.strictEqual(build.studio_build,'GKS-B867');assert.strictEqual(build.game_build,'GA-B486.213');
