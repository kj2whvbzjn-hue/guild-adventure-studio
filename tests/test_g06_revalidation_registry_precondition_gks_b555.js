...
assert(src.includes("if(!genericRegistry)await loadGenericDefinition();"),
...
assert(src.includes("effectTypeCount:Object.keys(genericRegistry?.authoring?.effect_types||{}).length"),
