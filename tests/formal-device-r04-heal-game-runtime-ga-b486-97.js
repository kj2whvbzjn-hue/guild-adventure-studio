...
assert.deepStrictEqual(generated.compiledSkill.tags.slice(0,4),['味方','単体','HEAL','HEAL=120']);
...
assert.strictEqual(generated.compiledSkill.runtimeContracts.triggerContract.dispatchMode,'RESOLVE_ONLY');
