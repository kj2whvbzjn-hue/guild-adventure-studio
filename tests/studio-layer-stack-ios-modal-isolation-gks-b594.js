...
assert.ok(html.includes('<script src="./layer-controller.js?v=611"></script>'),'common layer controller must load before Studio app logic');
...
console.log('PASS GKS-B611 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
