...
assert.strictEqual(build.studio_build,'GKS-B683');
...
console.log('PASS GKS-B683 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
