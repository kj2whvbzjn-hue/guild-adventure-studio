...
assert.strictEqual(build.studio_build,'GKS-B615');
...
console.log('PASS GKS-B615 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
