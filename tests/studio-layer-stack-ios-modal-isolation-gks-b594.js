...
assert.strictEqual(build.studio_build,'GKS-B665');
...
console.log('PASS GKS-B665 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
