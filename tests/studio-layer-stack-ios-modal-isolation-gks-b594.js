...
assert.strictEqual(build.studio_build,'GKS-B645');
...
console.log('PASS GKS-B645 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
