...
assert.strictEqual(build.studio_build,'GKS-B640');
...
console.log('PASS GKS-B640 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
