...
assert.strictEqual(build.studio_build,'GKS-B662');
...
console.log('PASS GKS-B662 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
