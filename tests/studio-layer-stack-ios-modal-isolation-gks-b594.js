...
assert.strictEqual(build.studio_build,'GKS-B689');
...
console.log('PASS GKS-B689 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
