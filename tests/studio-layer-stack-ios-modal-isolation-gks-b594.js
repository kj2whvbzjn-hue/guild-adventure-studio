...
assert.strictEqual(build.studio_build,'GKS-B690');
...
console.log('PASS GKS-B690 common Studio layer stack: inert background, z-order, scroll lock, foreground-only iOS touch routing, and nested picker restoration');
