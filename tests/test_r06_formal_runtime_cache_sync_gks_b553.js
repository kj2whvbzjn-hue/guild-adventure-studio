...
for(const needle of [
 '../assets/shared/config/runtime-config.js?v=486180b571',
 './assets/js/tag-skill-runtime.js?v=486180b571',
 './assets/js/studio-skill-bridge.js?v=486180b571',
 './assets/js/app-runtime.js?v=486180b571'
])assert.ok(html.includes(needle),'game html stale cache key: '+needle);
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486180b571'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486180-b571',
 '../Export/skill/skills.json?v=486180b571',
 '../assets/shared/config/runtime-config.js?v=486180b571',
 './assets/js/tag-skill-runtime.js?v=486180b571',
 './assets/js/studio-skill-bridge.js?v=486180b571',
 './assets/js/app-runtime.js?v=486180b571'
