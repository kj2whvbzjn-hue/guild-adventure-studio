...
assert.strictEqual(build.studio_build,'GKS-B587');
...
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486182b587'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486182-b587',
