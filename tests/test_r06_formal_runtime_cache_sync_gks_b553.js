...
for(const needle of [
 '../assets/shared/config/runtime-config.js?v=486174b557',
 './assets/js/tag-skill-runtime.js?v=486174b557',
 './assets/js/studio-skill-bridge.js?v=486174b557',
 './assets/js/app-runtime.js?v=486174b557'
])assert.ok(html.includes(needle),'game html stale cache key: '+needle);
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486174b557'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486174-b557',
 '../Export/skill/skills.json?v=486174b557',
 '../assets/shared/config/runtime-config.js?v=486174b557',
 './assets/js/tag-skill-runtime.js?v=486174b557',
 './assets/js/studio-skill-bridge.js?v=486174b557',
 './assets/js/app-runtime.js?v=486174b557'
