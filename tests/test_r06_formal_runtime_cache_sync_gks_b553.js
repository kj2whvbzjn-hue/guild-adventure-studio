...
assert.strictEqual(build.studio_build,'GKS-B613');
...
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486191b613'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486191-b613',
