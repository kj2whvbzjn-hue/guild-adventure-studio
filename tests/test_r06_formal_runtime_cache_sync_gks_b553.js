...
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486122b553'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486122-b553',
...
assert.ok(!html.includes('studio-skill-bridge.js?v=486122b549'));
assert.ok(!html.includes('app-runtime.js?v=486122b549'));
assert.ok(!html.includes('tag-skill-runtime.js?v=486122b550'));
