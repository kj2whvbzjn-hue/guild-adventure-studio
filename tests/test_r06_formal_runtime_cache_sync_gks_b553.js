...
assert.strictEqual(build.studio_build,'GKS-B614');
...
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486192b614'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486192-b614',
