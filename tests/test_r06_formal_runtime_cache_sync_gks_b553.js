...
for(const needle of [
 '../assets/shared/config/runtime-config.js?v=486136b555',
 './assets/js/tag-skill-runtime.js?v=486136b555',
 './assets/js/studio-skill-bridge.js?v=486136b555',
 './assets/js/app-runtime.js?v=486136b555'
])assert.ok(html.includes(needle),'game html stale cache key: '+needle);
assert.ok(cfg.includes("skillExportUrl: '../Export/skill/skills.json?v=486136b555'"),'formal Export cache key stale');
for(const needle of [
 'ga-game-b486136-b555',
 '../Export/skill/skills.json?v=486136b555',
 '../assets/shared/config/runtime-config.js?v=486136b555',
 './assets/js/tag-skill-runtime.js?v=486136b555',
 './assets/js/studio-skill-bridge.js?v=486136b555',
 './assets/js/app-runtime.js?v=486136b555'
