...
const author=ctx.GKSGenericSkillAuthoringRegistry;assert.ok(author);assert.ok(['G02','G03'].includes(author.VERSION));
assert.ok(['G02','G03'].includes(registry.authoring.phase));
