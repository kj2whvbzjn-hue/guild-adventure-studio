...
const author=ctx.GKSGenericSkillAuthoringRegistry;assert.ok(author);assert.strictEqual(author.VERSION,'G02');
assert.strictEqual(registry.authoring.phase,'G02');
...
const html=fs.readFileSync('studio/index.html','utf8');assert.ok(html.includes('generic-skill-authoring-registry.js?v=2'));assert.ok(html.includes('skill-generator.js?v=7'));
