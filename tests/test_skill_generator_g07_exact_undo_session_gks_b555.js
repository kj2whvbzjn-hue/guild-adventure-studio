...
assert.ok(html.includes('skill-generator.js?v=37'),'Skill generator rollback must cache-bust');
assert.ok(html.includes('data-exchange-ui.js?v=25'),'Data Exchange UI rollback must cache-bust');
