...
ctx.GKSSkillHost={
 getData:()=>host,getBuild:()=> 'GKS-B546',
...
(async()=>{
 ...
 const html=fs.readFileSync('studio/index.html','utf8');assert.ok(html.includes('skill-generator.js?v=24'));
 console.log('PASS GKS-B546 G07 acceptance stale/broken/conflict/audit/undo gate');
