...
const committed=S.commitStoredQuestRun(saveStore,'QR-STORE-1',{applyReward:(s,r)=>s.guild.gold+=r.gold||0,applyFlags:(s,f)=>Object.assign(s.flags,f)},Date.parse('2026-08-11T00:02:00.000Z'));
...
const legacy=S.normalizeQuestRun({quest_run_id:'QR-LEGACY',timeline_result:[{box_id:'OLD-1'}],final_result:{success:false,failure:{reason:'legacy'}}});
assert.deepEqual(legacy.final_result.final_state,{status:'failure',processed_box_count:1,last_processed_box_id:'OLD-1'});
