...
assert.ok(/^R04-[BCDE]\d+$/.test(registry.phase)||/^R0[5-9]-/.test(registry.phase)||/^R[1-9][0-9]-/.test(registry.phase));
assert.ok(/^R04-[BCDE]\d+$/.test(generic.VERSION)||/^R0[5-9]-/.test(generic.VERSION)||/^R[1-9][0-9]-/.test(generic.VERSION));
