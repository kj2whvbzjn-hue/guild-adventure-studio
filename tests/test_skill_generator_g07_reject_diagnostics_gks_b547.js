...
const page=fs.readFileSync('studio/index.html','utf8');assert.ok(page.includes('skill-generator.js?v=36'));
console.log('PASS GKS-B550 G07 human-readable reject diagnostics');
