...
assert.ok(/^R04-[BCDE]/.test(registry.phase),`unexpected phase ${registry.phase}`);
assert.ok(/^R04-[BCDE]/.test(generic.VERSION),`unexpected compiler version ${generic.VERSION}`);
