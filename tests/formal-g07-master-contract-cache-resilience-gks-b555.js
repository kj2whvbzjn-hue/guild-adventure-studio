...
assert(html.includes('skill-schema.js?v=2b555'),'Skill Schema cache bust missing');
assert(html.includes('skill-generator.js?v=29'),'Skill Generator cache bust missing');
assert(html.includes('data-exchange-core.js?v=16'),'Data Exchange cache bust missing');
