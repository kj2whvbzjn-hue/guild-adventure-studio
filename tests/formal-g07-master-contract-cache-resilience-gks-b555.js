...
assert(html.includes('skill-generator.js?v=37'),'Skill Generator cache bust missing');
assert(html.includes('data-exchange-core.js?v=19'),'Data Exchange cache bust missing');
