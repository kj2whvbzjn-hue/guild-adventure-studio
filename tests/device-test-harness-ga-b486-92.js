...
const tagIndex='game-tag-test/index.html';
const tagSwPath='game-tag-test/sw.js';
...
if(fs.existsSync(tagIndex))assert(!fs.readFileSync(tagIndex,'utf8').includes('device-tag-test-harness.js'),'retired tag-test device harness still loaded by tag-test');
if(fs.existsSync(tagSwPath))assert(!fs.readFileSync(tagSwPath,'utf8').includes('device-tag-test-harness.js'),'retired tag-test device harness still precached');
