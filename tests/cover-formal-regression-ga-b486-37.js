...
const errors=[];
if(build.game_build!=='GA-B486.48')errors.push(`build=${build.game_build}`);
...
if(!bridge.includes('tag-formal-runtime-regression-GA-B486.48-'))errors.push('formal filename build mismatch');
