...
const errors=[];
if(build.game_build!=='GA-B486.43')errors.push(`build=${build.game_build}`);
...
if(!bridge.includes("schema_version:'1.7.0'"))errors.push('formal schema version mismatch');
if(!bridge.includes('tag-formal-runtime-regression-GA-B486.43-'))errors.push('formal filename build mismatch');
