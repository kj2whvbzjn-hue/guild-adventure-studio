...
if(!bridge.includes("build:'GA-B486.15'"))throw new Error('formal build not updated');
if(!bridge.includes('return applyTaggedStatus(actor,target'))throw new Error('formal CLEANSE fixture is not connected to applyTaggedStatus');
if(bridge.includes('return applyStatusEffect(actor,target'))throw new Error('obsolete applyStatusEffect reference remains');
console.log('CLEANSE_FORMAL_FIXTURE_GA_B486_15_OK');
