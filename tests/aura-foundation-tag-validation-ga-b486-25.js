...
if(!['tag_validation_ready','device_json_validation_ready','runtime_connection_v1','runtime_connection_v1_revive_fix'].includes(spec.status))errors.push(`spec_status=${spec.status}`);
