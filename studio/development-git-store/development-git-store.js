/* GKS-B731 Development Git Store
...
async function remoteFile(c,{requireSha=false}={}){
 // GKS-B731: one authenticated raw Contents request is the normal read path.
...
async function refreshRegistry(entries=[]){
 // GKS-B731: project-list rendering must not fan out GitHub API requests.
