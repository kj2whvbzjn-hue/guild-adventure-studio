/* GKS-B729 Development Git Store
...
async function remoteFile(c,{requireSha=false}={}){
 // GKS-B729: one authenticated raw Contents request is the normal read path.
...
async function refreshRegistry(entries=[]){
 // GKS-B729: project-list rendering must not fan out GitHub API requests.
