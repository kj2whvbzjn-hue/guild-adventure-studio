/* GKS-B718 Development Git Store
...
async function remoteFile(c,{requireSha=false}={}){
 // GKS-B718: one authenticated raw Contents request is the normal read path.
...
async function refreshRegistry(entries=[]){
 // GKS-B718: project-list rendering must not fan out GitHub API requests.
