/* GKS-B719 Development Git Store
...
async function remoteFile(c,{requireSha=false}={}){
 // GKS-B719: one authenticated raw Contents request is the normal read path.
...
async function refreshRegistry(entries=[]){
 // GKS-B719: project-list rendering must not fan out GitHub API requests.
