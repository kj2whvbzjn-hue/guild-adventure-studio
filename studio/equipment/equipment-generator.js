...
const AI_FORBIDDEN_NUMERIC_FIELDS=['required_str','required_dex','required_int','required_vit','required_mnd','required_agi','attack','accuracy','magic_weapon_bonus','weapon_critical_rate','block_rate','block_damage_cut_rate','hp_bonus','mp_bonus','evasion'];
...
function generateWeapon(input){
  ...
  const out={id:String(input.id||''),name:String(input.name||defaultName),status:'draft',tags:withRequiredEquipmentTags(type,input.tags),params:{},description:String(input.description||''),mod_ids:[],item_level:i,required_str,required_dex,required_int,attack,accuracy,magic_weapon_bonus,weapon_critical_rate,...(isShield?{block_rate,block_damage_cut_rate}:{})};
