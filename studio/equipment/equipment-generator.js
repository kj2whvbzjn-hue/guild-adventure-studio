...
function renderPanel(){
  ...
  function templateFor(kindName){return {schema:'GKS_EQUIPMENT_GENERATION_REQUEST',version:'1.0.0',requests:kindName==='weapon'?[{kind:'weapon',base_item_types:['片手剣','短剣'],item_level:{min:1,max:3},id_prefix:'EQP-AI-W',seed:'ai-weapon'}]:[{kind:'armor',base_item_types:['重装'],armor_slots:['鎧','頭'],item_level:{min:1,max:3},id_prefix:'EQP-AI-A',seed:'ai-armor'}]};}
