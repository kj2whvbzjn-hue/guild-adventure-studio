...
const AI_FORBIDDEN_NUMERIC_FIELDS=['required_str','required_dex','required_int','required_vit','required_mnd','required_agi','attack','accuracy','magic_weapon_bonus','base_critical_rate','block_rate','block_damage_cut_rate','hp_bonus','mp_bonus','evasion'];
...
function generateWeapon(input){
  ...
  const base_critical_rate=Number(perf.base_critical_rate),isShield=type==='盾';
