const CACHE_NAME="gks-studio-b656";
const CACHE_PREFIX="gks-studio-";
const OFFLINE_URL='./index.html?appv=656';
const APP_SHELL=[
  "./",
  "./index.html?appv=656",
  ...
  "./development-workspace-ui.css?v=1",
  ...
  "./development-ai-publish/development-ai-publish.js?v=1",
