const CACHE_NAME="gks-studio-b689";
const CACHE_PREFIX="gks-studio-";
const OFFLINE_URL='./index.html?appv=689';
const APP_SHELL=[
  "./",
  "./index.html?appv=689",
  ...
  "./development-source-package/development-source-package.js?v=2",
