const CACHE_NAME="gks-studio-b600";
const CACHE_PREFIX="gks-studio-";
const OFFLINE_URL='./index.html?appv=600';
const APP_SHELL=[
  "./",
  "./index.html?appv=600",
  ...
  "./ai-production/ai-layout-model.js?v=1",
  "./ai-production/ai-connection-resolver.js?v=1",
