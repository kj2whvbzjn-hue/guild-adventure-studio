const CACHE_NAME="gks-studio-b688";
const CACHE_PREFIX="gks-studio-";
const OFFLINE_URL='./index.html?appv=688';
const APP_SHELL=[
  "./",
  "./index.html?appv=688",
  ...
  "./development-source-package/development-source-package.js?v=1",
