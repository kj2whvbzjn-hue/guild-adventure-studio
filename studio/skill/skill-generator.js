...
function g06StrictSkillIssues(skill,index=0){
 ...
 if(!skill||typeof skill!=='object'||Array.isArray(skill))return[{code:'G06_SKILL_INVALID',path:base,message:'Skill objectが必要です'}];
...
function renderPanel(){
 ...
 q('skgG06GenericExport').onclick=()=>{try{download('G06_Skills.json',g06ExportSkills());}catch(e){q('skgAiBatchStatus').textContent='G06出力エラー: '+e.message;}};
