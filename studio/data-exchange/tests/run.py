...
def ui_selection_rule():
    ...
    story_required=['GKSDataExchangeUI.openStoryPicker()', '>データ出力</button>']
    ...
    for marker in ["datasets:['chapters','story_sections','story_scenes','story_dialogues']","title:'シナリオ データ出力'"]:
        if marker not in ui:
