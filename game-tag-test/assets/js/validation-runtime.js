...
function tagTestRunReviveJson(){
 ...
 const single=(hp=100)=>({id:'SKL-TEST-REVIVE-100',name:'単体蘇生100',tags:['REVIVE','味方','単体',`REVIVE_HP=${hp}`]});
