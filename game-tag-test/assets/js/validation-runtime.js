...
function setupTagSkillTestUI(){
 ...
 if(runCooldownJson)runCooldownJson.onclick=tagTestRunCooldownJson;if(runCostJson)runCostJson.onclick=tagTestRunCostJson;if(runR05GenericDirectRuntimeJson)runR05GenericDirectRuntimeJson.onclick=tagTestRunR05GenericDirectRuntimeJson;
