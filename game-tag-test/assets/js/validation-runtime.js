...
function setupTagSkillTestUI(){
 ...
 if(runCooldownJson)runCooldownJson.onclick=tagTestRunCooldownJson;if(runCostJson)runCostJson.onclick=tagTestRunCostJson;if(runR05GenericDirectRuntimeJson)runR05GenericDirectRuntimeJson.onclick=tagTestRunR05GenericDirectRuntimeJson;if(runR06LegacyGenericRuntimeJson)runR06LegacyGenericRuntimeJson.onclick=tagTestRunR06LegacyGenericRuntimeJson;
